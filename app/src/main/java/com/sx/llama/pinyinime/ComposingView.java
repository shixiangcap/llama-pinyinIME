...
public class ComposingView extends View {
     ...
     */
    private final Drawable mHlDrawable;

    /**
     * Drawable used to draw cursor for editing mode.
     */
    private final Drawable mCursor;
    ...
    private final int mStrColor;
    private final int mStrColorHl;
    private final int mStrColorIdle;
