...
public class SkbContainer extends RelativeLayout implements OnTouchListener {
     ...
     *
     * @see com.sx.llama.pinyinime.InputModeSwitcher for detailed layout
     * definitions.
     */
     ...
     */
    private final BalloonHint mBalloonPopup;
     ...
     * Popup sub keyboard.
     */
    private final PopupWindow mPopupSkb;
     ...
     */
    private final int[] mSkvPosInContainer = new int[2];
     ...
     */
    private final LongPressTimer mLongPressTimer;

    /**
     * For temporary use.
     */
    private final int[] mXyPosTmp = new int[2];
    ...
    private void updateSkbLayout() {
        ...
        if (null == mSkbFlipper) {
            ...
            // mSkbFlipper.setVisibility(View.INVISIBLE);
        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        // 如果当前没有弹出键盘，则调用 GestureDetector 的 onTouchEvent 方法处理触摸事件
        if (!mPopupSkbShow) {
